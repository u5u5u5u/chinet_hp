  ...
  return (
    <div className="flex flex-col items-center space-y-20 bg-[#c2c2c2] text-black py-20">
      ...
      <section className="flex justify-between">
        ...
        <div className="flex flex-col justify-center space-y-4 w-[70%] lg:w-[600px] lg:h-[500px] border-2 shadow-xl rounded-[26%_74%_70%_30%_/_30%_26%_74%_70%] backdrop-blur-sm py-[8%] px-[8%] mt-48 -ml-40">
          <h3 className="text-xl md:text-2xl lg:text-3xl font-bold">01 自習場所の提供</h3>
